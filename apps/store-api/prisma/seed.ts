...
async function seedPages(prisma: PrismaClient) {
  ...
  const pagesData: {
    ...
    },
    {
      ...
      metaTitle: 'Публічна оферта | MobileStore',
      metaDescription:
        'Публічна оферта (договір купівлі-продажу) інтернет-магазину MobileStore: предмет договору, порядок замовлення, ціна й оплата, доставка, повернення, реквізити продавця.',
      content: `
