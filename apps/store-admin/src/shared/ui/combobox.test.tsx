/**
 * `Combobox` — ported into store-admin with the component (TASK-423).
 *
 * The spec travels with the port on purpose: the `aria-activedescendant` contract
 * below is the part of the WAI-ARIA combobox pattern that is invisible on screen
 * and therefore the part a future "small tidy-up" in this app would break without
 * anyone noticing.
 */
