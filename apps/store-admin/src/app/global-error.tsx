...
/**
 * App Router global error boundary for the admin panel.
 *
 * Renders its own `<html>`/`<body>` (it replaces the root layout) and forwards the
 * error to Sentry (no-op when the SDK is disabled — no `NEXT_PUBLIC_SENTRY_DSN`).
 */
      ...
      <body className="min-h-screen bg-background text-foreground">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Сталася неочікувана помилка в панелі адміністратора.
          </p>
          <button
            type="button"
            onClick={() => reset()}
