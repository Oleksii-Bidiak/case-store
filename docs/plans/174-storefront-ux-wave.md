...
Не робили: **TASK-420** (слаги замість id) — відкладено, бо план 182 усе одно переписує ту саму
зону фільтрів; **TASK-217** (`/orders` у кабінет) — потребує макета, окрема сесія.
