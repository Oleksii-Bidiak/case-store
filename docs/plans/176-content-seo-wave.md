...
> переписує хвиля 174) → TASK-546 після мержу 174; TASK-437 додав `BlogPost` повний набір
> мета-полів, не лише `ogImage`/`keywords`; TASK-434 поглинув TASK-492, крім вставки
> зображень (немає ендпоінта до TASK-424) → TASK-547.
>
> **Хвости** — рядки TASK-546…564 у `BACKLOG.md`, підрозділ «Хвости хвилі 176». Найважчий —
> TASK-563 (каталог рендериться на клієнті); найдорожчий для SEO — TASK-550 (`noindexSite`
